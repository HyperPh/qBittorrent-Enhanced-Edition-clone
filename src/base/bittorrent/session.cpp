...
static const char USER_AGENT[] = "qBittorrent/3.3.16";
...
#else
    std::string peerId = libt::generate_fingerprint(PEER_ID, QBT_VERSION_MAJOR, QBT_VERSION_MINOR, QBT_VERSION_BUGFIX, 0);
